//Requerimiento 1. cambia el color del titulo y alterna 
...
//Requerimiento 2. funcion para generar números aleatorios
...
// captacion de filas y columas para los candy
...
//Ubica los elemento caramelo en el tablero
function checkBoard() {
	fillBoard();
}
...
//Requerimiento 7. interacción del usuario con el elemento caramelo es drag and drop
...
//Requerimiento 4 y 6. temporizador y boton reiniciar
//cambiamos la apariencia  de la página al final del juego
function endGame() {
...
function initGame() {	
	...
	$('.btn-reinicio').click(function () {
		...
		if ($(this).text() === 'Iniciar')
			{
				//Eliminamos el contenido: 02:00 y lo dejamos vacio
				$('#timer').html("")
			} 
		else
			{
